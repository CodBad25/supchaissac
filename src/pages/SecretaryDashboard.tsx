                ...
                <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold">{teachers.filter(t => t.inPacte).reduce((sum, t) => sum + (t.pacteHoursDF || 0), 0)}h</p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold">{teachers.filter(t => t.inPacte).reduce((sum, t) => sum + (t.pacteHoursRCD || 0), 0)}h</p>
                    </div>
                            ...
                            <td className="px-4 py-3 text-center">
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  // Activer le toggle si des heures antérieures sont déjà saisies
          ...
          <div className="bg-white rounded-2xl max-w-md w-full">
            ...
            <div className="p-6 space-y-6">
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-medium text-sm">Reprise en cours d'année</span>
                    <p className="text-xs opacity-70">Cliquer si des heures ont été effectuées avant l'app</p>
                  </div>
                  {showPreviousHours && (
              ...
              <div className="bg-amber-50 p-4 rounded-lg">
                ...
                <div className="mt-3 text-center">
                  <p className="text-xs text-gray-500">
                    Reste a realiser : <span className="font-bold text-gray-700">{Math.max(0, (contratHoursDF + contratHoursRCD) - (contratCompletedDF + contratCompletedRCD))}h</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    const response = await fetch(`${API_BASE_URL}/api/pacte/teachers/${editingContrat.id}/contrat`, {
                      method: 'PATCH',
                      headers: { 'Content-Type': 'application/json' },
                      credentials: 'include',
                      body: JSON.stringify({
